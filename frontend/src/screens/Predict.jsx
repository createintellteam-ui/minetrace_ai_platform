      ...
      <Card title="Mined tonnage — history + forecast">
        <ResponsiveContainer width="100%" height={260}>
          <LineChart data={merged} margin={{ top: 8, right: 8, bottom: 0, left: -8 }}>
            ...
            <XAxis dataKey="day" fontSize={10} tick={{ fill: 'var(--text-muted)' }} />
            ...
            <Line type="monotone" dataKey="forecast_mt" stroke="var(--fill-pro)" strokeWidth={2} strokeDasharray="5 5" dot={true} />
          </LineChart>
        </ResponsiveContainer>
